...
# METHOD DISCARDED FOR EFFECT ON SAMPLE SIZES
# Method One: Continuous measure of voter propensity for change
# Voter Change Score
...
here::i_am("code/old/3_1_discrete_validity_testing.R")
...
var_names_ref_discrete <- read_csv(here("discrete_validity_reftable.csv"))
